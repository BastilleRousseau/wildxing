...
library(devtools)
install.github("BastilleRousseau/wildxing")
...
# Intersect of animal home-ranges with linear featurs   - *hr_split*

# Segmenting of linear corridors in smaller fragments  - *SegmentSpL*

# Intersect of an animal trajectory with a corridor   - *corriIntersects*

# Intersect of multiple animal trajectories with a corridor and population average   - *corriIntersects_All* and *avg_inds*

# Optimization of crossing structures positioning  - *corri_optim*
